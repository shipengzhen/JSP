...
<%
	...
	//要显示的用户
	String xuid=uid;//request.getParameter("uid");
	if(xuid==null)return;
        ...
        <title>一笑网-资料修改</title>
       	...
       	<style type="text/css">
       		...
       		*{ margin: 0px; padding: 0px; }
       		...
       		/*尾部*/
       		#wei{  height: 100px; float: left; background-color:#e4e4e4;margin:-80px auto;
       																}
       		#wei1 li{ 
			...
			/*身体的下部分*/
			#message{width:998px;height:700px;border-top:1px solid #CCC;}
			/*放头像的位置*/
			.img{padding-left:40px;}
			/*鼠标悬浮，移开时的样式*/
			.baocun{text-decoration:none;color:#333;}
			.baocun:hover{text-decoration:underline;color:#39F;}
			/*放 “基本资料” 的p标签样式*/
			...
			/*修改资料部分*/
			.xiugai{line-height:60px;font-size:16px;color:#333;padding-left:20px;}
			/*文字“发过的帖子”样式*/
    ...
    <body>
    	...
    	<div id="div1">
                ...
                <div id="message">
                	<div id="zhong">
                    	<p class="falst">
                            ...
                            <strong>基本资料</strong>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a class="baocun" href="#">保存</a>
                        </p>
                        <div id="ban">
                        	<form id="form1" action="do_xiu.jsp" method="post">
                            	<p class="xiugai">
                            		昵称：<input class="height" type="text" name="name" value="<%=xu.getUName() %>"/><span class="ts1"><!--存放提示信息--></span>
                        		</p>
                        		
                        		<p class="xiugai">
                            		密码：<input class="height" type="password" name="pwd" value="<%=xu.getPwd() %>"/><span class="ts1"><!--存放提示信息--></span>
                        		</p>
                        		
                                <p class="xiugai">
                                    性别：
                                    <input name="sex1" type="radio" checked="checked" value="男"/>男
                                    <input name="sex1" type="radio" value="女"/>女
                                </p>
                                <p class="xiugai">
                                    Email：<input class="height" type="text" name="email" value="<%=xu.getUEmail() %>"/><span class="ts2"><!--存放提示信息--></span>
                                </p>
                                <p class="xiugai">
                                    联系手机：<input class="height" type="text" name="phone" value="<%=xu.getUPhone() %>"/><span class="ts3"><!--存放提示信息--></span>
                                </p>
                                <p class="xiugai">
                                    个性签名：<input class="height" type="text" name="jy" value="<%=xu.getUxy() %>"/>
                                </p>
                                <p>
                                    <input type="submit" id="tijiao" name="tijiao" value="确定" style="display: none;"/>
                                </p>
                            </form>
                        </div>
                    </div>
	    	...
	    	<div id="wei">
            	...
            	<form id="ttt" style="display: none;" action="do_tou.jsp" enctype="multipart/form-data" method="post">
            		<input type="file" name="sctou" id="sctou" value=""  accept="image,.jpg,.png,.jpeg,.gif" />
