...
<%
	...
	//session.setAttribute("uid","10007");//此局以后要删
	...
	int dx=10;//页大小
	int zong=ip.RPostCount(null);//指定ID的总条数,null为全部
	...
	if(shai.equals("1")){
		ps=ip.RPostByTIDandX(null,10);
	}
	if(shai.equals("2")){
		ps=ip.RPostByFenTID(dx,dang,null);
	}
    	...
    	<div id="div1">
    		...
    		<div id="tou">
    			...
    			<div id="toun">
	    			...
	    			<div id="dhl">
	    				<ul>
	    					<li><a id="ben"  href="shou.jsp">首页</a></li>
    		...
    		<div id="shenti">
    			...
    			<div id="left">
    				...
    				<div id="left1">
    					<ul>
    						<li class="lt1"><a href="shou.jsp?shai=1">推荐</a></li>
    						<li><a href="shou.jsp?shai=2">全部</a></li>
    					</ul>
    				</div>
    				...
    				<div class="x1">
				        <div class="x11">
				        	<ul class="xin1">
				        		<!--头像-1->
					        	<li><a href="#"><img class="touxiang" src="../photo/10001/tou.png" width="55px" height="55px" /></a></li>	
				        		<li class="name"><a href="#">啊实打实的</a></li>
				        		<li class="jibie"><a>白银Ⅲ</a></li>
				        		<li class="time">2010-1-1 12:20</li>
				        	</ul>
				        </div>
			      	  	<div class="neirong">
			        		<ul>
				        		<!--标题-1->
				        		<li class="bt"><a name="biaoti" href="">老婆喜欢读三国</a></li>
				        		<!--内容-1->
				        		<li class="wen">
									啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦
									啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦<br/><br/><br/>
									啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦
									<br/><br/>
									啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦<br/><br/><br/>
									啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦啦
			        	...
			        	<div class="zan">
			        		<ul>
			        			<li class="z1" pid="111"><img src="../img/shou/ding.png"/></li>
			        			<li class="z2">0</li>
			        			<li class="z3" pid="111"><img src="../img/shou/cai.png"/></li>
			        			<li class="z4">0</li>
			        			<li class="z5"><img src="../img/shou/zan.png"/></li>
			        			<li class="z6">0</li>
			        		</ul>
			        	</div>
		       		 </div>
    				...
    				<%if(shai.equals("1")){%>
    					<div id="fy">
				             <ul>
					             <li class="fy1"><a href="shou.jsp?shai=1&dan=<%=1%>">再来一波</a></li>
				             </ul>
	                	 </div>
    				<%}else if(shai.equals("2")){%>
	    				<div id="fy">
				             <ul>
					             <li class="fy1"><a href="shou.jsp?shai=2&dan=<%=1%>">首页</a></li>
					             <li class="fy1"><a href="shou.jsp?shai=2&dan=<%=dshang%>">上一页</a></li>
					             <li><a href="#"><%=dang%>/<%=zy%></a></li>
					             <li class="fy1"><a href="shou.jsp?shai=2&dan=<%=dxia%>">下一页</a></li>
					             <li class="fy1"><a href="shou.jsp?shai=2&dan=<%=zy%>">末页</a></li>
				             </ul>
	                	 </div>
	                <%}%>
