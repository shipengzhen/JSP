...
<%
	...
	int dx=10;//页大小
	int zong=ip.RPostCount("1");//指定ID的总条数,1---段子
	...
	if(shai.equals("1")){
		ps=ip.RPostByTIDandX("1",10);
	}
	if(shai.equals("2")){
		System.out.println("当前页："+dang);
		ps=ip.RPostByFenTID(dx,dang,"1");
	}
    	...
    	<div id="div1">
    			...
    			<div id="toun">
	    			...
	    			<div id="dhl">
	    				<ul>
	    					...
	    					<li><a  id="ben"  href="duan.jsp">段子</a></li>
    		...
    		<div id="shenti">
    			...
    			<div id="left">
    				...
    				<div id="left1">
    					<ul>
    						<li class="lt1"><a href="duan.jsp?shai=1">推荐</a></li>
    						<li><a href="duan.jsp?shai=2">全部</a></li>
    					</ul>
    				</div>
    				...
    				<%if(shai.equals("1")){%>
    					<div id="fy">
				             <ul>
					             <li class="fy1"><a href="duan.jsp?shai=1&dan=<%=1%>">再来一波</a></li>
				             </ul>
	                	 </div>
    				<%}else if(shai.equals("2")){%>
	    				<div id="fy">
				             <ul>
					             <li class="fy1"><a href="duan.jsp?shai=2&dan=<%=1%>">首页</a></li>
					             <li class="fy1"><a href="duan.jsp?shai=2&dan=<%=dshang%>">上一页</a></li>
					             <li><a href="#"><%=dang%>/<%=zy%></a></li>
					             <li class="fy1"><a href="duan.jsp?shai=2&dan=<%=dxia%>">下一页</a></li>
					             <li class="fy1"><a href="duan.jsp?shai=2&dan=<%=zy%>">末页</a></li>
				             </ul>
	                	 </div>
	                <%}%>
