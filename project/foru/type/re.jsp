...
<%
	...
	if(shai.equals("1")){
		ps=ip.RPostByPZanMM(dx, dang);//本月热
	}
	if(shai.equals("2")){
		ps=ip.RPostByPZan(dx, dang);//全部热
	}
    	...
    	<div id="div1">
    			...
    			<div id="toun">
	    			...
	    			<div id="dhl">
	    				<ul>
	    					...
	    					<li><a id="ben"  href="re.jsp">热门</a></li>
    		...
    		<div id="shenti">
    			...
    			<div id="left">
    				...
    				<div id="left1">
    					<ul>
    						<li class="lt1"><a href="re.jsp?shai=1">本月</a></li>
    						<li><a href="re.jsp?shai=2">全部</a></li>
    					</ul>
    				</div>
    				...
    				<!--再来一波or分页-->
    				<%if(shai.equals("1")||shai.equals("2")){%>
	    				<div id="fy">
				             <ul>
					             <li class="fy1"><a href="re.jsp?shai=<%=shai%>&dan=<%=1%>">首页</a></li>
					             <li class="fy1"><a href="re.jsp?shai=<%=shai%>&dan=<%=dshang%>">上一页</a></li>
					             <li><a href="#"><%=dang%>/<%=zy%></a></li>
					             <li class="fy1"><a href="re.jsp?shai=<%=shai%>&dan=<%=dxia%>">下一页</a></li>
					             <li class="fy1"><a href="re.jsp?shai=<%=shai%>&dan=<%=zy%>">末页</a></li>
				             </ul>
	                	</div>
	                <%}%>
